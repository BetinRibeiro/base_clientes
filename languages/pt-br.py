...
'%(nrows)s records found': '%(nrows)s registos encontrados',
'%d-%m-%Y': '%d-%m-%Y',
...
'Back': 'Voltar',
'Business Presentation': 'Apresentar Negocio ',
...
'distributor': 'Consultor',
'Distributors': 'Consultores',
...
'genre': 'Gênero ',
'Graph Model': 'Modo Grafico',
'Grid Example': 'Exemplo de Grade',
'Group ID': 'ID do Grupo',
'Group uniquely assigned to user %(id)s': 'Group uniquely assigned to user %(id)s',
'Groups': 'Grupos',
'Hello World': 'Olá Mundo',
'Helping web2py': 'Ajuda do web2py',
...
'Invite to Event': 'Convidar (Evento)',
'JSON': 'JSON',
...
'Name': 'Nome',
'name client': '',
'Name Client': 'Nome do Ciente',
'Name Distributor': 'Nome do Consultor',
'name distributor': 'Nome Consultor',
...
'Product Presentation': 'Apresentação (Produto)',
'Profile': 'Perfil',
...
'Sale': 'Venda',
'Sale Schedule': 'Agendamento (Venda)',
